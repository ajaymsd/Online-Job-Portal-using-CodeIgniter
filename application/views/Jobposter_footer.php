    ...
    <div class="row"> 
      ...
      <div class="col-md-2 col-sm-6">
        ...
        <ul class="quicklinks">
          ...
          <li><a href="<?php echo base_url('Jobposter/Prov_Job')?>">Your Jobs</a></li>
          <li><a href="<?php echo base_url('Jobposter')?>#review ">Success Stories</a></li>
          <li><a href="<?php echo base_url('Jobposter/Prov_contact')?>">Contact Us</a></li>
          <li><a href="<?php echo base_url('Login')?>">Create Account</a></li>
          <li><a href="<?php echo base_url('Jobposter/Prov_postjob')?>">Post a Job</a></li>
        </ul>
      </div>
...
<div class="copyright">
  <div class="container">
    <div class="bttxt">Copyright &copy; 2023 AstroWebSolution. All Rights Reserved. Designed and Developed By : <a href="https://training.astrowebsolution.com" target="_blank">Ajay Mathesh & Sreeram</a></div>
  </div>
</div>
