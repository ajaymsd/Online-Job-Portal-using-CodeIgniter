    ...
    <div class="row"> 
      ...
      <div class="col-md-2 col-sm-6">
        ...
        <ul class="quicklinks">
          ...
          <li><a href="<?php echo base_url('Jobseeker/Job')?>">Job Listings</a></li>
          <li><a href="<?php echo base_url('Jobseeker')?>#review ">Success Stories</a></li>
          <li><a href="<?php echo base_url('Jobseeker/Contact')?>">Contact Us</a></li>
