...
<div class="about-wraper"> 
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-5">
        <div class="postimg"><img src="<?php echo base_url('images/about-us-img1.jpg')?>" alt="your alt text" /></div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <ul class="row whatList">
        <li class="col-md-4 col-sm-6">
          <div class="iconWrap">
            <div class="icon"><i class="fa fa-user" aria-hidden="true" style="margin-top:21%;margin-left:2%;"></i></div>
          </div>
        ...
        <li class="col-md-4 col-sm-6">
          <div class="iconWrap">
            <div class="icon"><i class="fa fa-file-text" style="margin-top:21%;margin-left:2%;"></i></div>
          </div>
          <h3>Post a JOB</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque porttitor congue enim non rhoncus. Sed ac lacus non elit malesuada blandit.</p>
        </li>
        <li class="col-md-4 col-sm-6">
          <div class="iconWrap">
            <div class="icon"><i class="fa fa-briefcase" aria-hidden="true" style="margin-top:21%;margin-left:2%;"></i></div>
          </div>
          <h3>Hire a Employee</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque porttitor congue enim non rhoncus. Sed ac lacus non elit malesuada blandit.</p>
        </li>
      </ul>
    </div>
  ...
  <div class="textrow">
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <div class="postimg"><img src="<?php echo base_url('images/about-us-img2.jpg')?>" alt="your alt text" /></div>
        </div>
        <div class="col-md-7">
          <h2>Our Expertise</h2>
          <p>Doctus omnesque duo ne, cu vel offendit erroribus. Laudem hendrerit pro ex, cum postea delectus ad. Te pro feugiat perpetua tractatos. Nam movet omnes id, usu te meis corpora. Augue doming quaestio vix at. Sumo duis ea sed, ut vix euismod lobortis prodesset, everti necessitatibus mei cu.<br>
